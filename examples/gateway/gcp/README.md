# Viqo Gateway on Google Cloud

Reference deployment artifacts for running Viqo Gateway on GCP with Agent
...
| `Dockerfile` | Runtime image for the `viqo gateway` binary |
