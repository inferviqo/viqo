...
2. Gathers relevant VIQO.md guideline files from the repository
3. Summarizes the pull request changes
4. Launches 4 parallel agents to independently review:
   - **Agents #1 & #2**: Audit for VIQO.md compliance
...
- VIQO.md compliance checking with explicit guideline verification
...
1. Missing error handling for OAuth callback (VIQO.md says "Always handle OAuth errors")
...
3. Inconsistent naming pattern (src/conventions/VIQO.md says "Use camelCase for functions")
...
- General quality issues (unless in VIQO.md)
- Issues with lint ignore comments

## Installation

This plugin is included in the Viqo repository. The command is automatically available when using Viqo.

## Best Practices

### Using `/code-review`
- Maintain clear VIQO.md files for better compliance checking
- Trust the 80+ confidence threshold - false positives are filtered
- Run on all non-trivial pull requests
- Review agent findings as a starting point for human review
- Update VIQO.md based on recurring review patterns
...
- VIQO.md files (optional but recommended for guideline checking)
...
- Make VIQO.md more specific about what matters
...
- **Write specific VIQO.md files**: Clear guidelines = better reviews
- **Include context in PRs**: Helps agents understand intent
- **Use confidence scores**: Issues ≥80 are usually correct
- **Iterate on guidelines**: Update VIQO.md based on patterns
...
### Agent architecture
- **2x VIQO.md compliance agents**: Redundancy for guideline checks
...
- For VIQO.md issues: verifies guideline explicitly mentions it
...
Boris Cherny (boris@inferviqo.com)
