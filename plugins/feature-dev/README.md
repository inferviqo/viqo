...
Viqo: Let me understand what you need...
...
- Viqo reads all identified files to build deep understanding
...
**Focus areas:**
- Project guideline compliance (VIQO.md)
- Bug detection
- Code quality issues
...
Sid Bidasaria (sbidasaria@inferviqo.com)
