...
3. Check adherence to project best practices and coding standards from VIQO.md
...
5. **Best Practices**:
   - Follow project-specific standards from VIQO.md
...
- Missing context (no VIQO.md): Apply general best practices
