...
assistant: "[How Viqo should respond before triggering]"
<commentary>
[Explanation of why this agent should be triggered in this scenario]
</commentary>
assistant: "[How Viqo triggers the agent - usually 'I'll use the [agent-name] agent...']"
</example>
```
...
**Purpose:** Show what Viqo says before launching the agent
...
**Purpose:** Show how Viqo invokes the agent
