...
Deployment state saved to `.viqo/deployment-state.local.md`:
...
Reading deployment state from `.viqo/deployment-state.local.md`...
...
```markdown
.viqo/plugin-name-workflow.local.md:
...
Reading workflow state from .viqo/plugin-name-workflow.local.md...

Current stage: @.viqo/plugin-name-workflow.local.md
...
State file: @.viqo/plugin-name-workflow.local.md
...
Creating: .viqo/feature-complete.flag
...
if [ -f .viqo/feature-complete.flag ]; then
...
if [ -f .viqo/deployment.lock ]; then
...
!`validate.sh`
echo "checkpoint:validation" >> .viqo/deployment-checkpoints.log

## Checkpoint 2: Build
!`build.sh`
echo "checkpoint:build" >> .viqo/deployment-checkpoints.log

## Checkpoint 3: Deploy
!`deploy.sh`
echo "checkpoint:deploy" >> .viqo/deployment-checkpoints.log
...
Written to .viqo/deployment-state.local.md
...
Reading state: @.viqo/deployment-state.local.md
...
rm .viqo/deployment-state.local.md
