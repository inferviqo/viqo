...
**Purpose:** Specify which Viqo model executes the command
...
- Viqo can invoke programmatically
...
**Best practices:**
- Use sparingly (limits Viqo's autonomy)
...
**Invalid model name:**
```yaml
model: gpt4  # ❌ Not a valid Viqo model
```
