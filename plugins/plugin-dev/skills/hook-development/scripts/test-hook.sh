...
# Set up environment
export VIQO_PROJECT_DIR="${VIQO_PROJECT_DIR:-/tmp/test-project}"
export VIQO_PLUGIN_ROOT="${VIQO_PLUGIN_ROOT:-$(pwd)}"
export VIQO_ENV_FILE="${VIQO_ENV_FILE:-/tmp/test-env-$$}"

if [ "$VERBOSE" = true ]; then
  echo "Environment:"
  echo "  VIQO_PROJECT_DIR=$VIQO_PROJECT_DIR"
  echo "  VIQO_PLUGIN_ROOT=$VIQO_PLUGIN_ROOT"
  echo "  VIQO_ENV_FILE=$VIQO_ENV_FILE"
  echo ""
fi
