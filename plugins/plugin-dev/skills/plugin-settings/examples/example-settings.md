...
**.viqo/experimental-features.local.md:**
...
# Read settings
FRONTMATTER=$(sed -n '/^---$/,/^---$/{ /^---$/d; p; }' ".viqo/my-plugin.local.md")
...
Changes require Viqo restart - hooks can't be hot-swapped.
